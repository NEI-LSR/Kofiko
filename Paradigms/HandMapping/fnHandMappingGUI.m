...
strctControllers.m_hToggleLUVPSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Toggle luv plot',...
     'Position', [2*iButtonWidth-140 iPanelHeight-600 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''toggleluvpsthplot'');']);
	 
strctControllers.m_hClearLUVPSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Clear',...
     'Position', [2*iButtonWidth-40 iPanelHeight-600 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''clearluvpsthplot'');']);
...
strctControllers.m_hBlockLists = uicontrol('Style', 'listbox', 'String', acBlockNames,...
    'Position', [5 iPanelHeight-480 ,strctDesignControllers.m_iPanelWidth-10 250], 'parent',strctDesignControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''JumpToBlock'');'],...
    'value',1,'max',100);
...
strctControllers.m_hFixationSpotChange = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Load Image Set',...
     'Position', [5 iPanelHeight-520 iButtonWidth+40 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''LoadImageSet'');'],'FontWeight','bold');
...
strctControllers.m_hFixationSpotChange = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'pushbutton', 'String', 'New Fixation Spot',...
     'Position', [5 iPanelHeight-550 iButtonWidth+40 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FixationSpot'');'],'FontWeight','bold');
...
strctControllers.m_hResetStimPosition = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Reset Stim Spot',...
     'Position', [5 iPanelHeight-580 iButtonWidth+40 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ResetStimulusPosition'');'],'FontWeight','bold');
...
strctControllers.m_hDisplayStimuliLocally = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Play Stimuli Locally','value', g_strctParadigm.m_bDisplayStimuliLocally,...
     'Position', [5 iPanelHeight-iOffset-210 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''PlayStimuliLocally'');']);
  ...
  strctControllers.m_hSetStimulusClipping = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Stimulus Clipping','value', g_strctParadigm.m_bClipStimulusOutsideStimArea,...
     'Position', [5 iPanelHeight-iOffset-250 220 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SetStimulusClipping'');']);
...
strctControllers.m_hShowWhileLoading = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Show While Loading','value',  g_strctParadigm.m_bShowWhileLoading,...
     'Position', [5 iPanelHeight-iOffset-280 220 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ShowWhileLoading'');']);
...
strctControllers.m_hRepeatNonFixated= uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Repeat Non Fixated','value',  g_strctParadigm.m_bRepeatNonFixatedImages,...
     'Position', [5 iPanelHeight-iOffset-310 220 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RepatNonFixatedToggle'');']);
 ...
 strctControllers.m_hForceStereoOnMonocularLists= uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Force Stereo in Monocular Designs','value',  bForceStereo,...
     'Position', [5 iPanelHeight-iOffset-340 220 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ForceStereoToggle'');']);
 ...
 if isfield(g_strctParadigm,'m_strLocalStereoMode')
  ...
  strctControllers.m_hLocalStereoModeText = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'text', 'String', ...
     'Local Stereo Mode','Position', [5 iPanelHeight-iOffset-370 130 20],'HorizontalAlignment','left');
 ...
 strctControllers.m_hLocalStereoModePopup = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'popupmenu', 'String', ...
     ...
     'Position', [130 iPanelHeight-iOffset-400 160 60], 'Callback', [g_strctParadigm.m_strCallbacks,'(''LocalStereoMode'');']);

  strctControllers.m_hBlocksDoneText = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'text', 'String', ...
     'After blocks action:','Position', [5 iPanelHeight-iOffset-430 100 20],'HorizontalAlignment','left');
