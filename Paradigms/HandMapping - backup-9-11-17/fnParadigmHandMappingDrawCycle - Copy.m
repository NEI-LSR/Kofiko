...
if g_strctDraw.m_strctTrial.m_bUseGaussianPulses
    ...
    %}
    for iNumOfBars = 1:g_strctDraw.m_strctTrial.m_iNumberOfBars
        if ~strcmp(g_strctDraw.m_strctTrial.m_strTrialType, 'Many Bar')
            for iBlurStep = 1:g_strctDraw.m_strctTrial.numberBlurSteps
            ...
            for iBlurStep = 1:g_strctDraw.m_strctTrial.numberBlurSteps(iNumOfBars)
                if any(g_strctDraw.m_strctTrial.coordinatesX(iNumOfBars).Coords(1:4,g_strctDraw.m_iFrameCounter,iNumOfBars,iBlurStep))
                    if ~g_strctDraw.m_strctTrial.m_bUseBitsPlusPlus
                        
                        Screen('FillPoly',g_strctPTB.m_hWindow, g_strctDraw.m_strctTrial.m_aiBlurStepHolder(:,...
                            g_strctDraw.m_strctTrial.m_iBlurStepIDX(iNumOfBars,1)+iBlurStep),...
                            horzcat(g_strctDraw.m_strctTrial.coordinatesX(iNumOfBars).Coords(1:4,g_strctDraw.m_iFrameCounter,iNumOfBars,iBlurStep),...
                            g_strctDraw.m_strctTrial.coordinatesY(iNumOfBars).Coords(1:4,g_strctDraw.m_iFrameCounter,iNumOfBars,iBlurStep)),0)
                    else
                        Screen('FillPoly',g_strctPTB.m_hWindow, g_strctDraw.m_strctTrial.m_aiBlurStepHolder(:,...
                            g_strctDraw.m_strctTrial.m_iBlurStepIDX(iNumOfBars,1)+iBlurStep),...
                            horzcat(g_strctDraw.m_strctTrial.coordinatesX(iNumOfBars).Coords(1:4,g_strctDraw.m_iFrameCounter,iNumOfBars,iBlurStep),...
