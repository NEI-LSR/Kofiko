...
elseif	 ~g_strctPTB.m_variableUpdating  && g_strctPTB.m_strctControlInputs.m_mousePosition(1) >= g_strctPTB.m_aiScreenRect(1) && ...
		...
		switch g_strctParadigm.m_strCurrentlySelectedVariable
			case {'StimulusPosition', 'SecondaryStimulusPosition','TertiaryStimulusPosition','AFCChoiceLocation'}
...
switch g_strctParadigm.m_strCurrentlySelectedVariable
    case {'StimulusPosition', 'AFCChoiceLocation'}
    ...
    case {'SecondaryStimulusPosition'}
        g_strctParadigm.m_aiCenterOfSecondaryStimulus(1) = g_strctPTB.m_startingVariableValue(1) + ...
            ((g_strctPTB.m_strctControlInputs.m_mousePosition(1)-g_strctPTB.m_startingVariableValue(1)) +...
            g_strctPTB.m_strctControlInputs.m_stimulusMovementMouseOffset(1)) ;
			
        g_strctParadigm.m_aiCenterOfSecondaryStimulus(2) = g_strctPTB.m_startingVariableValue(2) + ...
            ((g_strctPTB.m_strctControlInputs.m_mousePosition(2)-g_strctPTB.m_startingVariableValue(2)) +...
            g_strctPTB.m_strctControlInputs.m_stimulusMovementMouseOffset(2)) ;
    ...
    case {'TertiaryStimulusPosition'}
        g_strctParadigm.m_aiCenterOfTertiaryStimulus(1) = g_strctPTB.m_startingVariableValue(1) + ...
            ((g_strctPTB.m_strctControlInputs.m_mousePosition(1)-g_strctPTB.m_startingVariableValue(1)) +...
            g_strctPTB.m_strctControlInputs.m_stimulusMovementMouseOffset(1)) ;
			
        g_strctParadigm.m_aiCenterOfTertiaryStimulus(2) = g_strctPTB.m_startingVariableValue(2) + ...
            ((g_strctPTB.m_strctControlInputs.m_mousePosition(2)-g_strctPTB.m_startingVariableValue(2)) +...
            g_strctPTB.m_strctControlInputs.m_stimulusMovementMouseOffset(2)) ;
