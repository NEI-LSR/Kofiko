...
% Felix note: data for dualstim is in, but noit displaying in GUI - check
% dependencies. Overaching gui name is "Handmapper" - check on ways to
% include things in GUI? and names
...
strctControllers.m_hSetDualstimPanel = uicontrol('Parent',hParadigmPanel, 'Style', 'pushbutton', 'String', 'Bar Variables',...
...
strctControllers.m_ahStimuliControllerButtons = [strctControllers.m_hSetPlainBarPanel, strctControllers.m_hSetMovingBarPanel,strctControllers.m_hSetDualstimPanel,...
					strctControllers.m_hSetTwoBarPanel, strctControllers.m_hSetManyBarPanel, strctControllers.m_hSetGaborPanel, strctControllers.m_hSetDiscPanel,...
					strctControllers.m_hSetImagePanel, strctControllers.m_hSetMoviePanel, strctControllers.m_hSetDesignPanel  strctControllers.m_hSetStatisticsPanel,...
                    strctControllers.m_hSetJuicePanel   strctControllers.m_hSetColorControlPanel ];
...
strctControllers.m_ahStimuliControllerButtonsStrLookup = {'PlainBarPanel','MovingBarPanel','DualstimPanel','TwoBarPanel','ManyBarPanel', 'GaborPanel','DiscPanel',...
    'ImagePanel','MoviePanel', 'DesignPanel',  'StatisticsPanel','JuicePanel', 'ColorControlPanel'};
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*16, ...
    'Bar Width', 'DualstimSecondaryWidth', ...
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*17, ...
    'Bar Length', 'DualstimSecondaryLength', ...
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*0, ...
    'Bar Width', 'DualstimMainWidth', ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm','DualstimMainWidth'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*1, ...
    'Bar Length', 'DualstimMainLength', ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm' ,'DualstimMainLength'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*2, ...
    'Orientation', 'DualstimMainOrientation', ...
    0, 359, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainOrientation'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*3, ...
    'Blur Steps', 'DualstimMainBlurSteps', ...
    0, 100, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainBlurSteps'));



	strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*4, ...
    'Speed', 'DualstimMainMoveSpeed', ...
    0, 1000, [1, 25], fnTsGetVar('g_strctParadigm' ,'DualstimMainMoveSpeed'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*5, ...
    'Number of Bars', 'DualstimMainNumberOfBars', ...
    1, 15, [1, 1], fnTsGetVar('g_strctParadigm' ,'DualstimMainNumberOfBars'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*6, ...
    'Stimulus Area', 'DualstimMainStimulusArea', ...
    0, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusArea'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*7, ...
    'Stimulus On Time', 'DualstimMainStimulusOnTime', ...
    10, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusOnTime'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*8, ...
    'Stimulus Off Time', 'DualstimMainStimulusOffTime', ...
    10, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusOffTime'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*9, ...
    'Bar Red', 'DualstimMainStimulusRed', ...
    0, 255, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusRed'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*10, ...
    'Bar Green', 'DualstimMainStimulusGreen', ...
    0, 255, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusGreen'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*11, ...
    'Bar Blue', 'DualstimMainStimulusBlue', ...
    0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusBlue'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*12, ...
    'Background Red', 'DualstimMainBackgroundRed', ...
    0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'DualstimMainBackgroundRed'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*13, ...
    'Background Green', 'DualstimMainBackgroundGreen', ...
    0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'DualstimMainBackgroundGreen'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*14, ...
    'Background Blue', 'DualstimMainBackgroundBlue', ...
    0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'DualstimMainBackgroundBlue'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*15, ...
    'Stimulus Color', 'DualstimMainStimulusPresetColor', ...
    1, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'DualstimMainStimulusPresetColor'));
...
strctControllers.m_hSetRandomStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Randomize Orientation','value',...
	g_strctParadigm.m_bRandomStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-220 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandStimulusOrientation'');']);	


strctControllers.m_hSetCycleStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Cycle Orientation','value',...
	g_strctParadigm.m_bCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-240 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''CycleStimulusOrientation'');']);	
	
strctControllers.m_hSetReverseCycleStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Reverse Orientation','value',...
	g_strctParadigm.m_bReverseCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-260 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ReverseCycleStimulusOrientation'');']);	
	  
strctControllers.m_hClearCurrentTestObjects = uicontrol('Parent', strctDualstimControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Clear Test Variables',...
      'Position', [5 iPanelHeight-iOffset-300 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ClearCurrentTestObjects'');']);	
	
strctControllers.m_hSetCurrentTestObject = uicontrol('Parent', strctDualstimControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Set Test Variable',...
      'Position', [5 iPanelHeight-iOffset-320 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SetCurrentSelectedVariableAsTestObject'');']);	

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*22, ...
    'Set Test Range', 'DualstimMainCurrentVariableModifyRange', ...
    1, 200, [1, 1], fnTsGetVar('g_strctParadigm' ,'CurrentVariableModifyRange'));
	  
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*23, ...
    'Set Test Hz', 'DualstimMainCurrentVariableModifySpeedHz', ...
    1, 200, [1, 1], fnTsGetVar('g_strctParadigm' ,'CurrentVariableModifySpeedHz'));	  
	
strctControllers.m_hSetReverseCycleStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Test Value','value',...
	g_strctParadigm.m_bRandomTestValue,...
    'Position', [5 iPanelHeight-iOffset-400 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SetRandomTestValue'');']);	
