...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainNumberOfBars', g_strctParadigm.m_fInitial_MovingBarNumberOfBars, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainWidth', g_strctParadigm.m_fInitial_MovingBarWidth, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainLength', g_strctParadigm.m_fInitial_MovingBarLength, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainOrientation', g_strctParadigm.m_fInitial_MovingBarOrientation, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainMoveDistance', g_strctParadigm.m_fInitial_MovingBarMoveDistance, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainMoveSpeed', g_strctParadigm.m_fInitial_MovingBarMoveSpeed, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusArea', g_strctParadigm.m_fInitial_MovingBarStimulusArea, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusRed', g_strctParadigm.m_fInitial_MovingBarStimulusRed, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusGreen', g_strctParadigm.m_fInitial_MovingBarStimulusGreen, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusBlue', g_strctParadigm.m_fInitial_MovingBarStimulusBlue, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainBackgroundRed', g_strctParadigm.m_fInitial_MovingBarBackgroundRed, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainBackgroundGreen', g_strctParadigm.m_fInitial_MovingBarBackgroundGreen, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainBackgroundBlue', g_strctParadigm.m_fInitial_MovingBarBackgroundBlue, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainBlur', g_strctParadigm.m_fInitial_MovingBarBlur, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainBlurSteps', g_strctParadigm.m_fInitial_MovingBarBlurSteps, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusOffTime', g_strctParadigm.m_fInitial_MovingBarStimulusOffTime, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusOnTime', g_strctParadigm.m_fInitial_MovingBarStimulusOffTime, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainStimulusPresetColor', g_strctParadigm.m_fInitial_MovingBarStimulusPresetColor, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainCurrentVariableModifySpeedHz', g_strctParadigm.m_fInitial_CurrentVariableModifySpeedHz, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DualstimMainCurrentVariableModifyRange', g_strctParadigm.m_fInitial_CurrentVariableModifyRange, iSmallBuffer);
...
g_strctParadigm.m_aiCenterOfSecondaryStimulus(1) = g_strctStimulusServer.m_aiScreenSize(3)/2;
g_strctParadigm.m_aiCenterOfSecondaryStimulus(2) = g_strctStimulusServer.m_aiScreenSize(4)/2;
