function fnNTlabDraw(bParadigmPaused)
%
...
global g_strctParadigm g_strctPTB
% previously plain bar stimulus - draw first so movingbar stuff draws on
% top of this on in case there's location conflict
