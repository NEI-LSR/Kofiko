...
strctControllers.m_hRepeatNonFixated= uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Repeat Non Fixated','value',  g_strctParadigm.m_bRepeatNonFixatedImages,...
 ...
 strctControllers.m_hToggleShowStimuliCoordinates = uicontrol('Parent',strctDesignControllers.m_hPanel,'Style', 'checkbox', 'String', 'Show Stimulus Coordinates','value', g_strctParadigm.m_bDisplayStimulusScreenCoordinates,...
     'Position', [5 iPanelHeight-iOffset-180 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ToggleShowScreenCoordinates'');']);
