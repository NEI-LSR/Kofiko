...
if ~isempty(g_strctParadigm.m_strctCurrentTrial) && g_strctParadigm.m_bDisplayStimulusScreenCoordinates%isfield(g_strctParadigm.m_strctCurrentTrial,'m_bDrawScreenCoords') && ...
						%g_strctParadigm.m_strctCurrentTrial.m_bDrawScreenCoords
		Screen(g_strctPTB.m_hWindow,'DrawText', sprintf('Screen Coordinates: X: %s     Y: %s', num2str(g_strctParadigm.m_aiCenterOfStimulus(1)),...
																 num2str(g_strctParadigm.m_aiCenterOfStimulus(2))),...
																g_strctPTB.m_aiRect(1),g_strctPTB.m_aiRect(2)+20, [0 255 0]);				
						
					%	g_strctParadigm.m_aiCenterOfStimulus
