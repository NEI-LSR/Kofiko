...
strctTrial.m_bFlipForegroundBackground = g_strctParadigm.m_bFlipForegroundBackground;
strctTrial.m_fImageFlipON_TS_StimulusServer = [];
strctTrial.m_fImageFlipON_TS_Kofiko = [];
strctTrial.m_bColorShift = 0;
strctTrial.m_iShiftOffset = 0;
strctTrial.m_bUseGaussianPulses  = g_strctParadigm.m_bUseGaussianPulses ;
strctTrial.m_bRandomStimulusPosition = g_strctParadigm.m_bRandomStimulusPosition;
strctTrial.m_iNumberOfBars = 1;
strctTrial.m_acstrCurrentlyVariableFields = g_strctParadigm.m_acstrCurrentlyVariableFields;
...
switch strctTrial.m_strTrialType
    ...
    case 'Two Bar'
        [strctTrial] = fnPrepare2BarTrial(g_strctPTB, strctTrial);
end
...
elseif g_strctParadigm.m_bUseCartesianCoordinates
    ...
    if ~g_strctParadigm.m_bCycleColors && ~g_strctParadigm.m_bRandomColor
        ...
        strctTrial.ai_dklAzimuthSteps = linspace(1,360,strctTrial.dklAzimuthSteps);
        strctTrial.dklElevationSteps = linspace(1,360,strctTrial.dklAzimuthSteps);
        ...
        if strctTrial.m_bUseGaussianPulses
            ...
            [strctTrial.m_iXCoordinate, strctTrial.m_iYCoordinate, strctTrial.m_iZCoordinate ] = sph2cart(deg2rad(strctTrial.ai_dklAzimuthSteps(g_strctParadigm.m_iCurrentlySelectedDKLCoordinateID)),...
                ones(1,strctTrial.numFrames)*(strctTrial.dklElevation/100)-1,sin(linspace(0,pi,strctTrial.numFrames))*strctTrial.dklRadius/100);
            ...
            [strctTrial.m_iXCoordinate, strctTrial.m_iYCoordinate, strctTrial.m_iZCoordinate ] = sph2cart(deg2rad(strctTrial.ai_dklAzimuthSteps),(strctTrial.dklElevation/100)-1,strctTrial.dklRadius/100);
            strctTrial.m_iZCoordinate = (strctTrial.dklElevation/100)-1;
        end
...
TestObjects = size(g_strctParadigm.m_acstrCurrentlyVariableFields,1);
if any(TestObjects)
	for iTestObjects = 1:TestObjects
    testRange = (g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6}*g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2})*4;
	fullCycleTimeS = 1/g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,3};
   
	%for iTestObjects = 1:TestObjects
	
            changeBy = g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,5} * ...
            ...
            newVal = g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,4} + changeBy;
         
				
			if newVal <= g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2} + g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} && ...
                newVal >= max(1,g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} - g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2})
            
            
                g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,4} = newVal;
				
				
				
            elseif  newVal > g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2} + g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} 
            
                g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,5} = -g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,5};
				
				
                newVal = (g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2} + g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6}) - rem(newVal, g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2} + g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6}) ;
            
            
                %abs(g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,4} - (g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
				%g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2} + g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6})))
                
              
            elseif  newVal < max(1,g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6}  - ...
                    g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
                    g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2}) 
                g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,5} = -g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,5};
                
                bottomCap = max(1,g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6}  - ...
                    g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,6} * ...
                    g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,2}) ;
                if newVal == 0
                   newVal = 1e-4;
			...
			switch g_strctParadigm.m_acstrCurrentlyVariableFields{iTestObjects,1}
				case {'StaticBarLength', 'MovingBarLength'}
					strctTrial.m_iLength = newVal;
					
				case {'StaticBarMoveSpeed', 'MovingBarMoveSpeed'}
					strctTrial.m_iMoveSpeed = newVal;
					strctTrial.m_iMoveSpeed
			end
	%end
	end
...
if ~strcmp(g_strctParadigm.m_strCurrentlySelectedVariable, 'StimulusPosition') && ~strcmp(g_strctParadigm.m_strCurrentlySelectedVariable, 'ColorPicker')
			...
			if ~any(strcmp(g_strctParadigm.m_strCurrentlySelectedVariable,g_strctParadigm.m_acstrCurrentlyVariableFields))
				CurrentVariableIDX = size(g_strctParadigm.m_acstrCurrentlyVariableFields,1) + 1;
			else
				CurrentVariableIDX = find(strcmp(g_strctParadigm.m_strCurrentlySelectedVariable, g_strctParadigm.m_acstrCurrentlyVariableFields));
			
			end
			
			
			
			g_strctParadigm.m_acstrCurrentlyVariableFields{CurrentVariableIDX+1,1} = g_strctParadigm.m_strCurrentlySelectedVariable;
			
			g_strctParadigm.m_acstrCurrentlyVariableFields{CurrentVariableIDX,2} =...
									squeeze(g_strctParadigm.CurrentVariableModifyRange.Buffer(1, :, g_strctParadigm.CurrentVariableModifyRange.BufferIdx));
			
			g_strctParadigm.m_acstrCurrentlyVariableFields{CurrentVariableIDX,3} =...
									squeeze(g_strctParadigm.CurrentVariableModifySpeedHz.Buffer(1, :, g_strctParadigm.CurrentVariableModifySpeedHz.BufferIdx));
