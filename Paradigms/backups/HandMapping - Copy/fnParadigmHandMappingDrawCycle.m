...
if ~g_strctDraw.m_bLoadOnTheFly
    ...
    [g_strctDraw.m_strctTrial.hMovieHandle, ~] = Screen('OpenMovie', g_strctPTB.m_hWindow, g_strctDraw.m_strctTrial.m_strMovieFilePath);
...
if fCurrTime - g_strctServerCycle.m_fMovieStartTime > g_strctDraw.m_strctTrial.fDuration
	fnStimulusServerToKofikoParadigm('FlipOFF',g_strctServerCycle.m_fLastFlipTime);
	fnStimulusServerToKofikoParadigm('TrialFinished');
	g_strctServerCycle.m_iMachineState = 3;
    if g_strctDraw.m_bLoadOnTheFly
        Screen('Close',g_strctDraw.m_strctTrial.hMovieHandle);
    end    
	return;
