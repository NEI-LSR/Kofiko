function bSuccessful = fnNTlab_mTurkPlusInit()
%
...
global g_strctParadigm g_strctDynamicStimLog g_strctAppConfig g_strctPTB g_strctDAQParams g_strctSystemCodes g_strctCycle g_strctRealTimeStatServer
...
g_strctParadigm.m_iMaxTrialsToKeepInBuffer = 400;
...
% felix added to replace: 
linearclut=linspace(0,65535,256)';
g_strctParadigm.m_afMasterClut=cat(2,linearclut,linearclut,linearclut);
...
%% predefine target stimuli
fnInitializeMkTurkPlusTextures('all', 'Z:\StimulusSet\NTlab_mTurkPlus\', 1, 1, [], 1, 0, 14)
fnParadigmToStimulusServer('ForceMessage', 'PrepareMkTurkTextures', 'all', 'Z:\StimulusSet\NTlab_mTurkPlus\', 1, 1, [], 1, 0, 14);  

g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MkTurkTaskType', g_strctParadigm.m_fInitial_MkTurkTaskType, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MkTurkNumChoices', g_strctParadigm.m_fInitial_MkTurkNumChoices, iSmallBuffer);
...
g_strctParadigm.Dualstim_pregen_achromcloud_n =  g_strctParadigm.m_fInitial_DualstimPregen_achromcloud_n;
g_strctParadigm.DensenoiseAchromcloud = (mk_spatialcloud(25,25, g_strctParadigm.Dualstim_pregen_achromcloud_n, g_strctParadigm.DensenoiseScale)./2 +.5).*255;
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'ETStimulusPosition', g_strctParadigm.m_afInitial_ETStimulusPosition, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'ETStimulusArea', g_strctParadigm.m_fInitial_ETStimulusArea, iSmallBuffer);

%g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MkTurkCuePosition', g_strctParadigm.m_afInitial_ETStimulusPosition, iSmallBuffer);
g_strctParadigm.m_aiCenterofCueWin(1) = g_strctParadigm.m_strctStimServerVars.m_aiStimulusServerScreenSize(3)/2 +50;
g_strctParadigm.m_aiCenterofCueWin(2) = g_strctParadigm.m_strctStimServerVars.m_aiStimulusServerScreenSize(4)/2;
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MkTurkCuePosition', g_strctParadigm.m_aiCenterofCueWin, iSmallBuffer);

g_strctParadigm.m_aiCenterOfETStimulus(1) = g_strctParadigm.m_strctStimServerVars.m_aiStimulusServerScreenSize(3)/2 - 75;
g_strctParadigm.m_aiCenterOfETStimulus(2) = g_strctParadigm.m_strctStimServerVars.m_aiStimulusServerScreenSize(4)/2;
...
g_strctParadigm.m_strCurrentlySelectedVariable = 'ETStimulusPosition';
...
numInitialChoices = sum(cellfun(@numel,g_strctParadigm.m_cAllCueColorsPerSat));
...
g_strctParadigm.m_strctStimuliVars.m_bLuminanceMaskedCueStimuli = false;
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MemoryChoicePeriodMS', g_strctParadigm.m_fInitial_MemoryChoicePeriodMS, iSmallBuffer);
...
g_strctParadigm.m_strctPostTrialVars.m_bExtinguishNonSelectedChoicesAfterChoice = g_strctParadigm.m_fInitial_ExtinguishChoicesAfterSaccade;
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'HoldToSelectChoiceMS', g_strctParadigm.m_fInitial_RetainSelectedChoicePeriodMS, iSmallBuffer);
...
fnInitializeChoiceTextures(g_strctParadigm.m_strctChoiceVars.m_strChoiceDisplayType, fnTsGetVar('g_strctParadigm', 'NumTexturesToPreparePerChoice'), ...
                                            numInitialChoices, [fnTsGetVar('g_strctParadigm', 'ChoiceLength'),fnTsGetVar('g_strctParadigm', 'ChoiceWidth')], ...
