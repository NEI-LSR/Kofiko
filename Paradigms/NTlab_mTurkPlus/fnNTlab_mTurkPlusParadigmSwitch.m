function fnNTlab_mTurkPlusParadigmSwitch(strEvent)
%
...
switch strEvent
    case 'Init'
        ...
        if fnParadigmToStatServerComm('IsConnected') && isfield(g_strctParadigm,'m_strctDesign') && ~isempty(g_strctParadigm.m_strctDesign) 
