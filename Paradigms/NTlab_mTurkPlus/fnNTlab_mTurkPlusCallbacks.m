function fnNTlab_mTurkPlusCallbacks(strCallback,varargin)
%
...
%}
[~, controlComputerColors] = fnCalculateColorsForChoiceTrainingDisplay(activeSaturationsID,...
                                                                                    activeSaturationsStr, ...
                                                                                    colorConversionID, ...
																					fnTsGetVar('g_strctParadigm', 'CueLuminanceDeviation'), ...
                                                                                    numLuminanceStepsPerCue,...
...
fnInitializeCueTrainingTextures(stimulusTypeToPrepare, fnTsGetVar('g_strctParadigm', 'NumTexturesToPreparePerCue'), ...
    ...
    case 'UpdateETStimulusPosition'
        g_strctParadigm.m_strCurrentlySelectedVariable = 'ETStimulusPosition';
    
    case 'UpdateMkTurkCuePosition'
        g_strctParadigm.m_strCurrentlySelectedVariable = 'MkTurkCuePosition';
    
    case 'RecenterMkTurkCuePosition'
        g_strctParadigm.m_aiCenterofCueWin(1) = g_strctParadigm.m_strctStimServerVars.m_aiStimulusServerScreenSize(3)/2;
    ...
    case 'PregenACloudStimuli'
        ...
        g_strctParadigm.DensenoiseAchromcloud = round((mk_spatialcloud(25,25, g_strctParadigm.Dualstim_pregen_achromcloud_n, spatialscale)./2 +.5).*255);
