...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctRewardControllers.m_hPanel, 40+30*1, ...
    'Juice Time (ms):', 'JuiceTimeMS',25, 500, [5, 25], fnTsGetVar('g_strctParadigm','JuiceTimeMS'));
...
strctControllers.m_hBinaryReward = uicontrol('Parent',strctRewardControllers.m_hPanel,'Style', 'checkbox', 'String', 'Binary Reward','value',...
    ...
    'Position', [5 strctTrainingControllers.m_iPanelHeight-300 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''BinaryReward'');']);
...
strctControllers.m_hEnableEyeSmoothing = uicontrol('Parent',strctRewardControllers.m_hPanel,'Style', 'checkbox', 'String', 'Eye Smoothing','value',...
    ...
    'Position', [5 strctTrainingControllers.m_iPanelHeight-330 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''EnableEyeSmoothing'');']); 
...
%Felix added MkTurk Task slider
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctPreCueControllers.m_hPanel,40+30*0, ...
    'Task type:', 'MkTurkTaskType', 1, 7, [1, 1], fnTsGetVar('g_strctParadigm','MkTurkTaskType'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctPreCueControllers.m_hPanel, 40+30*5, ...
    'ET Stimulus Area', 'ETStimulusArea', ...
    1, 512, [5, 10], fnTsGetVar('g_strctParadigm' ,'ETStimulusArea')); %Felix note: should get adjusted in Callbacks to avoid aliasing issues as it scales
...
strctControllers.m_hUpdateETStimulusPosition = uicontrol('Parent', strctPreCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Update ET Stimulus Location',...
      'Position', [5 strctPreCueControllers.m_iPanelHeight-300 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UpdateETStimulusPosition'');']);	
	
strctControllers.m_hUpdateMkTurkCuePosition = uicontrol('Parent', strctPreCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Update Cue Location',...
      'Position', [5 strctPreCueControllers.m_iPanelHeight-320 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UpdateMkTurkCuePosition'');']);	
	
strctControllers.m_hRecenterMkTurkCuePosition = uicontrol('Parent', strctPreCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Recenter Cue Location',...
      'Position', [5 strctPreCueControllers.m_iPanelHeight-340 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RecenterMkTurkCuePosition'');']);	
...
%     'Length:', 'CueLength', 0, 300, [1, 1], fnTsGetVar('g_strctParadigm','CueLength'));	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctCueControllers.m_hPanel,40+30*3, ...
    'Width:', 'CueWidth', 0,300 , [1, 1], fnTsGetVar('g_strctParadigm','CueWidth'));
...
strctControllers.m_hGenerateCueTextures = uicontrol('Parent', strctCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Generate Cue Textures',...
      'Position', [5 strctCueControllers.m_iPanelHeight-235 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''GenerateCues'');']);
...
strctControllers.m_hSetCueHighlight = uicontrol('Parent',strctCueControllers.m_hPanel,'Style', 'checkbox', 'String', 'Highlight Cue','value',...
    ...
    'Position', [5 strctCueControllers.m_iPanelHeight-265 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''HighlightCue'');']);
...
strctControllers.m_hSetShowCue = uicontrol('Parent',strctCueControllers.m_hPanel,'Style', 'checkbox', 'String', 'Display Cue','value',...
    ...
    'Position', [5 strctCueControllers.m_iPanelHeight-295 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ShowCue'');']);
...
strctControllers.m_hForceBalanceCuePossibilities = uicontrol('Parent',strctCueControllers.m_hPanel,'Style', 'checkbox', 'String', 'Balance Cue Counts','value',...
    ...
    'Position', [5 strctCueControllers.m_iPanelHeight-350 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ForceBalanceCuePossibilities'');']);
	
 strctControllers.m_hUpdateStimulusPosition = uicontrol('Parent', strctCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Update Stimulus Location',...
      'Position', [5 strctCueControllers.m_iPanelHeight-375 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UpdateStimulusPosition'');']);
...
strctControllers.m_hCueColorConversionType = uicontrol('Style', 'listbox', 'String', g_strctParadigm.m_acAvailableColorSpaceNames,...
    'Position', [10 strctCueControllers.m_iPanelHeight-420 strctCueControllers.m_iPanelWidth-15 40], 'parent', strctCueControllers.m_hPanel, 'Callback', [g_strctParadigm.m_strCallbacks, '(''SelectCueColorConversionType'');'],...
...
strctControllers.m_hCueSaturationLists = uicontrol('Style', 'listbox', 'String', a2cCharMatrix,...
    'Position', [10 strctCueControllers.m_iPanelHeight-540 strctCueControllers.m_iPanelWidth-15 100], 'parent',strctCueControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''SelectCueSaturations'');'],...
...
strctControllers.m_hCueColorLists = uicontrol('Style', 'listbox', 'String', colorCell,...
    'Position', [10 strctCueControllers.m_iPanelHeight-650 ,strctCueControllers.m_iPanelWidth-15 100], 'parent',strctCueControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''SelectCueColors'');'],...
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctMemoryControllers.m_hPanel,40+30*1, ...
    'Memory Period (MS):', 'MemoryPeriodMS', 0, 3000, [10, 50], fnTsGetVar('g_strctParadigm','MemoryPeriodMS'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctMemoryControllers.m_hPanel,40+30*2, ...
    'Memory Choice Period (MS):', 'MemoryChoicePeriodMS', 0, 2000, [10, 50], fnTsGetVar('g_strctParadigm','MemoryChoicePeriodMS'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*0, ...
    'Number of Choices:', 'MkTurkNumChoices', 1, 12, [1, 1], fnTsGetVar('g_strctParadigm','MkTurkNumChoices'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*1, ...
    'Choice Width:', 'ChoiceWidth', 0, 300, [1, 10], fnTsGetVar('g_strctParadigm','ChoiceWidth'));
	
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*2, ...
%     'Choice Length:', 'ChoiceLength', 0, 300, [1, 10], fnTsGetVar('g_strctParadigm','ChoiceLength'));
% 	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*2, ...
    'Inside Choice Region (%):', 'InsideChoiceRegion', 0, 300, [1, 11], fnTsGetVar('g_strctParadigm','InsideChoiceRegion'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*3, ...
    'Hold To Select (MS):', 'HoldToSelectChoiceMS', 0, 2000, [10, 50], fnTsGetVar('g_strctParadigm','HoldToSelectChoiceMS'));
	%{}
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*4, ...
...
strctControllers.m_hSetRotateRingOnEachTrial = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Ring Rotation','value',...
   ...
   'Position', [5 iPanelHeight-455 250 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RotateChoiceRingOnEachTrial'');']);
%{
...
strctControllers.m_hForceChoiceColorConversionMatchToCueType = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Match Conversion to Cue','value',...
   ...
   'Position', [5 iPanelHeight-475 250 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ForceChoiceColorConversionMatchToCueType'');']);
%{
...
strctControllers.m_hSetInvertChoiceRingOnEachTrial = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Ring Inversion','value',...
   ...
   'Position', [5 iPanelHeight-495 250 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandomInvertChoiceRing'');']);
...
strctControllers.m_hGenerateChoiceTextures = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Generate Choice Textures',...
    'Position', [5 iPanelHeight-540 250 20],'callback', [g_strctParadigm.m_strCallbacks,'(''GenerateChoices'');']);	
...
strctControllers.m_hAFCChoiceLocation = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Update Choice Location',...
    'Position', [5 iPanelHeight-570 250 20],'callback', [g_strctParadigm.m_strCallbacks,'(''AFCChoiceLocation'');']);
...
strctControllers.m_hChoicePositionOptions = uicontrol('Style', 'listbox', 'String', ChoicePositionList,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-600 strctChoicesControllers.m_iPanelWidth-15 20],...
...
strctControllers.m_hChoiceSaturationLists = uicontrol('Style', 'listbox', 'String', a2cCharMatrix,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-640 strctChoicesControllers.m_iPanelWidth-15 40], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectSaturations'');'],...
...
strctControllers.m_hChoiceColorLists = uicontrol('Style', 'listbox', 'String', colorCell,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-700 ,strctChoicesControllers.m_iPanelWidth-15 40], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectColors'');'],...
    'value',g_strctParadigm.m_cAllChoiceColorsPerSat{:},'UIContextMenu',strctControllers.hColorListContextMenu, 'max', 16, 'min', 0);
	
stimTypes = {'disc','bar'};
stimCell = char(stimTypes);
strctControllers.m_hStimType = uicontrol('Style', 'listbox', 'String', stimCell,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-760 ,strctChoicesControllers.m_iPanelWidth-15 30], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''SelectStimType'');'],...
    'value',1,'UIContextMenu',strctControllers.hColorListContextMenu, 'max', 1, 'min', 1);
...
strctControllers.m_hChoiceColorConversionType = uicontrol('Style', 'listbox', 'String', g_strctParadigm.m_acAvailableColorSpaceNames,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-940 strctChoicesControllers.m_iPanelWidth-15 40], 'parent', strctChoicesControllers.m_hPanel, 'Callback', [g_strctParadigm.m_strCallbacks, '(''ChoiceSelectConversionType'');'],...
    'value', g_strctParadigm.m_strctInitialValues.m_fInitial_ColorConversionID, 'UIContextMenu', strctControllers.hColorListContextMenu, 'max', 1, 'min', 1);
	%}
	%g_strctParadigm.m_iCurrentColorConversionID = g_strctParadigm.m_strctInitialValues.m_fInitial_ColorConversionID;
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctPostTrialControllers.m_hPanel,40+30*1, ...
    'Retain Choice (ms):', 'RetainSelectedChoicePeriodMS', 0, 1000, [10, 50], fnTsGetVar('g_strctParadigm','RetainSelectedChoicePeriodMS'));
