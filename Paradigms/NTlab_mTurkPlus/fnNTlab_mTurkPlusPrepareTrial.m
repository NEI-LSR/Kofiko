function [strctCurrentTrial,strWhatHappened] =  fnNTlab_mTurkPlusPrepareTrial()
...
g_strctParadigm.RefreshrateMS = 1000/120; %g_strctParadigm.m_strctStimServerVars.m_fStimulusMonitorRefreshRate
...
elseif strcmp(g_strctParadigm.m_strCueType, 'circle')
    strctCurrentTrial.m_strctTrialParams.m_strStimulusType = 'circle';
    [strctCurrentTrial] = fnCalcDiscCoordinates(strctCurrentTrial);    
end

%Felix added
strctCurrentTrial.m_iMkTurkTaskType = fnTsGetVar('g_strctParadigm','MkTurkTaskType');
strctCurrentTrial.m_afBackgroundColor= squeeze(squeeze(g_strctParadigm.MkTurkTextBG));%[127, 127, 127];
...
strctCurrentTrial.m_strctPreCuePeriod.numFrames = round( strctCurrentTrial.m_strctPreCuePeriod.m_fPreCueFixationPeriodMS / g_strctParadigm.RefreshrateMS )+1;
%strctCurrentTrial.m_strctPreCuePeriod.stimseq = randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,strctCurrentTrial.m_strctPreCuePeriod.numFrames);
strctCurrentTrial.m_strctPreCuePeriod.stimseq=repmat(randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,round(strctCurrentTrial.m_strctPreCuePeriod.numFrames/2)),2,1);
strctCurrentTrial.m_strctPreCuePeriod.stimseq=strctCurrentTrial.m_strctPreCuePeriod.stimseq(:);
strctCurrentTrial.m_iPreCueFrameCounter = 1;
...
%    strctCurrentTrial.m_strctPreCuePeriod.m_afBackgroundColor= [1, 1, 1]; % Setup for bits ++
    strctCurrentTrial.m_strctPreCuePeriod.m_afBackgroundColor= strctCurrentTrial.m_afBackgroundColor; % Setup for bits ++
    ...
    % Felix added
    [strctCurrentTrial.m_strctPreCuePeriod.cuesize, cuesize_x, cuesize_y] = deal(fnTsGetVar('g_strctParadigm','CueWidth'));
    %strctCurrentTrial.m_strctTrialParams.CenterofCueWin = g_strctParadigm.m_aiCenterofCueWin;
    strctCurrentTrial.m_strctTrialParams.CenterofCueWin = fnTsGetVar('g_strctParadigm','MkTurkCuePosition');
        strctCurrentTrial.m_strctTrialParams.m_aiMkTurkCueWin=[strctCurrentTrial.m_strctTrialParams.CenterofCueWin(1)-cuesize_x;...
        strctCurrentTrial.m_strctTrialParams.CenterofCueWin(2)-cuesize_y;...
        strctCurrentTrial.m_strctTrialParams.CenterofCueWin(1)+cuesize_x;...
        strctCurrentTrial.m_strctTrialParams.CenterofCueWin(2)+cuesize_y];
%     strctCurrentTrial.m_strctTrialParams.m_aiMkTurkCueWin=[strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(1)-cuesize_x;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(2)-cuesize_y;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(1)+cuesize_x;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(2)+cuesize_y];

%     [strctCurrentTrial.m_strctPreCuePeriod.ETStimsize, ETStimsize_x, ETStimsize_y] = deal(fnTsGetVar('g_strctParadigm','ETStimArea'));
%     strctCurrentTrial.m_strctTrialParams.m_aiMkTurkCueETStimWin=[strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(1)-ETStimsize_x-250;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(2)-ETStimsize_y;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(1)+ETStimsize_x-250;...
%         strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter(2)+ETStimsize_y];
%     strctCurrentTrial.m_strctTrialParams.m_aiMkTurkCueETStimCol=0;
%     
strctCurrentTrial.m_strctTrialParams.m_aiMkTurkCueETStimWin = g_strctParadigm.m_aiETStimulusRect;
% strctCurrentTrial.m_strctTrialParams.m_aiStimulusServerScreenCenter = g_strctParadigm.m_aiETStimulusRect;
else
...
strctCurrentTrial.m_strctCuePeriod.m_afBackgroundColor= strctCurrentTrial.m_afBackgroundColor; % Setup for bits ++
...
strctCurrentTrial.m_strctCuePeriod.numFrames = ceil( strctCurrentTrial.m_strctCuePeriod.m_fCuePeriodMS / g_strctParadigm.RefreshrateMS )+1;
strctCurrentTrial.m_strctCuePeriod.stimseq=repmat(randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,round(strctCurrentTrial.m_strctCuePeriod.numFrames/2)),2,1);
strctCurrentTrial.m_strctCuePeriod.stimseq=strctCurrentTrial.m_strctCuePeriod.stimseq(:);
strctCurrentTrial.m_iCueFrameCounter = 1;
strctCurrentTrial.m_iLocalCueFrameCounter = 1;
...
global g_strctParadigm
g_strctParadigm.MemoryChoiceBool = 0;
...
strctCurrentTrial.m_strctMemoryPeriod.numFrames = ceil( (strctCurrentTrial.m_strctMemoryPeriod.m_fMemoryPeriodMS + strctCurrentTrial.m_strctMemoryPeriod.m_fMemoryChoicePeriodMS) / g_strctParadigm.RefreshrateMS )+1;
%strctCurrentTrial.m_strctMemoryPeriod.stimseq = randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,strctCurrentTrial.m_strctMemoryPeriod.numFrames);
strctCurrentTrial.m_strctMemoryPeriod.stimseq=repmat(randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,round(strctCurrentTrial.m_strctMemoryPeriod.numFrames/2)),2,1);
strctCurrentTrial.m_strctMemoryPeriod.stimseq=strctCurrentTrial.m_strctMemoryPeriod.stimseq(:);
...
if or(strctCurrentTrial.m_strctMemoryPeriod.m_fMemoryPeriodMS > 0, strctCurrentTrial.m_strctMemoryPeriod.m_fMemoryChoicePeriodMS > 0)
    strctCurrentTrial.m_strctMemoryPeriod.m_afBackgroundColor = strctCurrentTrial.m_afBackgroundColor;
...
if ~g_strctParadigm.m_bChoiceTexturesInitialized
    ...
    % Felix set
    strctCurrentTrial.m_strctChoiceVars.numSaturations = 1; %numel(get(g_strctParadigm.m_strctControllers.m_hChoiceSaturationLists,'value'));
    strctCurrentTrial.m_strctChoiceVars.numColors = fnTsGetVar('g_strctParadigm','MkTurkNumChoices');%4; %numel(get(g_strctParadigm.m_strctControllers.m_hChoiceColorLists,'value'));
    nTotalChoices = ((strctCurrentTrial.m_strctChoiceVars.numSaturations) * strctCurrentTrial.m_strctChoiceVars.numColors);

    strctCurrentTrial.m_iMkTurkChoiceIDs=randperm(14,nTotalChoices);
    strctCurrentTrial.m_iMkTurkTargetID=strctCurrentTrial.m_iMkTurkChoiceIDs(1);
    
strctCurrentTrial.m_iChoiceFrameCounter = 1;
strctCurrentTrial.m_iLocalChoiceFrameCounter = 1;
...
%         strcmpi(g_strctParadigm.m_strctChoiceVars.m_strChoiceDisplayType, 'nestedannuli')
    ...
    elseif strcmpi(g_strctParadigm.m_strctChoiceVars.m_strChoiceDisplayType, 'nestedannuli')
        ...
        if g_strctParadigm.m_strctChoiceVars.m_bRotateChoiceRingOnEachTrial
            ...
            strctCurrentTrial.m_strctChoiceVars.m_fChoiceRotationDegrees = floor(rand(1,1) * 359.99);
%             curChoiceDist=round(360/nTotalChoices);
%             strctCurrentTrial.m_strctChoiceVars.m_fChoiceRotationDegrees = [mod(floor(rand(1,1) * 359.99),curChoiceDist):curChoiceDist:359.99];
%             
        ...
        if g_strctParadigm.m_strctChoiceVars.m_bRandomRingOrderInversion 
            if round(rand(1,1))
                strctCurrentTrial.m_strctChoiceVars.m_bChoiceRingOrderInversion = true;
                 strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas = ...
            [359.999:-(360/strctCurrentTrial.m_strctChoiceVars.numColors):0];
            else
                strctCurrentTrial.m_strctChoiceVars.m_bChoiceRingOrderInversion = false;
                strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas = ...
            [0:360/strctCurrentTrial.m_strctChoiceVars.numColors:359.999];
            end
        else
        strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas = ...
            [0:360/strctCurrentTrial.m_strctChoiceVars.numColors:359.999];
        ...
        for iActiveSaturations = strctCurrentTrial.m_strctChoiceVars.numSaturations : -1 : 1
            strctCurrentTrial.m_strctChoiceVars.choiceRhos(iActiveSaturations) = iRhoSteps(iActiveSaturations);
            [tempX, tempY] = ...
                pol2cart(deg2rad(strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas + strctCurrentTrial.m_strctChoiceVars.m_fChoiceRotationDegrees), ...
                strctCurrentTrial.m_strctChoiceVars.choiceRhos(iActiveSaturations));
...
strctCurrentTrial.m_strctChoicePeriod.m_afBackgroundLUT= strctCurrentTrial.m_afBackgroundColor;

strctCurrentTrial.m_strctChoicePeriod.numFrames = strctCurrentTrial.m_iMaxFramesInChoiceEpoch+1;
%    strctCurrentTrial.m_strctChoicePeriod.stimseq = randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,strctCurrentTrial.m_strctChoicePeriod.numFrames);
strctCurrentTrial.m_strctChoicePeriod.stimseq = repmat(randi(g_strctParadigm.Dualstim_pregen_achromcloud_n,1,round(strctCurrentTrial.m_strctChoicePeriod.numFrames/2)),2,1);
strctCurrentTrial.m_strctChoicePeriod.stimseq = strctCurrentTrial.m_strctChoicePeriod.stimseq(:);
strctCurrentTrial.m_iChoiceFrameCounterResets = 0;
% strctCurrentTrial.m_strctChoicePeriod.m_iChoiceFrameCounter = 1;
% strctCurrentTrial.m_strctChoicePeriod.m_iLocalChoiceFrameCounter = 1;
...
%choice color temporarily nonfunctional
...
%Felix added: linear CLUT to keep things in RGB space
linearclut=linspace(0,65535,256)';
strctCurrentTrial.m_strctChoicePeriod.Clut=cat(2,linearclut,linearclut,linearclut);
...
strctCurrentTrial.m_strctChoicePeriod.m_afBackgroundColor = strctCurrentTrial.m_afBackgroundColor;
