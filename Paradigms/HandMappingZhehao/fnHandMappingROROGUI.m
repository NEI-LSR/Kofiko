...
[strctFilterControllers.m_hPanel, strctFilterControllers.m_iPanelHeight,strctFilterControllers.m_iPanelWidth] = ...
    fnCreateParadigmSubPanel(hParadigmPanel,50,iPanelHeight-5,'Filter Parameters');
...
strctControllers.m_hSubPanels = [strctDesignControllers.m_hPanel;...
								...
								strctTwoBarControllers.m_hPanel;...  % Siva comment:two bar GUI panel controller added to structController (go to line 692)
                                strctGaborControllers.m_hPanel;...
								strctDiscControllers.m_hPanel;...
								strctImageControllers.m_hPanel;...
								strctMovieControllers.m_hPanel;...
								strctManyBarControllers.m_hPanel; ... % Siva added for Many Bars
                                strctFilterControllers.m_hPanel] ;
...
strctControllers.m_hSetFilterPanel = uicontrol('Parent',hParadigmPanel, 'Style', 'pushbutton', 'String', 'Filter Variables',...
      'Position', [220 iPanelHeight-40 55 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FilterPanel'');']);
set(strctControllers.m_hSetFilterPanel,'enable','off');	  
set(strctControllers.m_hSetFilterPanel,'visible','off');	
	  
strctControllers.m_ahStimuliControllerButtons = [strctControllers.m_hSetPlainBarPanel, ...
...
strctControllers.m_ahStimuliControllerButtonsStrLookup = {'PlainBarPanel','MovingBarPanel','TwoBarPanel','ManyBarPanel', 'GaborPanel','DiscPanel',...
    'ImagePanel','MoviePanel', 'DesignPanel',  'StatisticsPanel','JuicePanel', 'ColorControlPanel', 'FilterPanel'};
...
strctControllers.m_hPrintStatFigure = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Print Stat figure',...
     'Position', [2*iButtonWidth-80 iPanelHeight-800 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''printstatfigure'');']);
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctPlainBarControllers.m_hPanel, 40+30*3, ...
    ...
    0, 1000, [1, 100], fnTsGetVar('g_strctParadigm' ,'PlainBarMoveDistance'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*0, ...
    'Filter Width', 'FilterWidth', ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm','FilterWidth'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*1, ...
    'Filter Length', 'FilterLength', ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm' ,'FilterLength'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*2, ...
    'Orientation', 'FilterOrientation', ...
    0, 359, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterOrientation'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*3, ...
    'Blur Steps', 'FilterBlurSteps', ...
    0, 100, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterBlurSteps'));
	%{
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMovingBarControllers.m_hPanel, 40+30*4, ...
    'Range', 'MovingBarMoveDistance', ...
    0, 1000, [1, 25], fnTsGetVar('g_strctParadigm' ,'MovingBarMoveDistance'));
	...
	strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*4, ...
    'Speed', 'FilterMoveSpeed', ...
    0, 1000, [1, 25], fnTsGetVar('g_strctParadigm' ,'FilterMoveSpeed'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*5, ...
    'Number of Filters', 'FilterNumberOfFilters', ...
    1, 15, [1, 1], fnTsGetVar('g_strctParadigm' ,'FilterNumberOfFilters'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*6, ...
    'Stimulus Area', 'FilterStimulusArea', ...
    0, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterStimulusArea'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*7, ...
    'Stimulus On Time', 'FilterStimulusOnTime', ...
    10, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterStimulusOnTime'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*8, ...
    'Stimulus Off Time', 'FilterStimulusOffTime', ...
    10, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterStimulusOffTime'));
	
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*9, ...
%     'Filter Red', 'FilterStimulusRed', ...
%     0, 255, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterStimulusRed'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*10, ...
%     'Filter Green', 'FilterStimulusGreen', ...
%     0, 255, [1, 2], fnTsGetVar('g_strctParadigm' ,'FilterStimulusGreen'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*11, ...
%     'Filter Blue', 'FilterStimulusBlue', ...
%     0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'FilterStimulusBlue'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*12, ...
%     'Background Red', 'FilterBackgroundRed', ...
%     0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'FilterBackgroundRed'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*13, ...
%     'Background Green', 'FilterBackgroundGreen', ...
%     0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'FilterBackgroundGreen'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*14, ...
%     'Background Blue', 'FilterBackgroundBlue', ...
%     0, 255, [1, 5], fnTsGetVar('g_strctParadigm' ,'FilterBackgroundBlue'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*10, ...
    'Quadrant n*', 'FilterBackgroundPresetColor', ...
    1, 7, [1, 1], fnTsGetVar('g_strctParadigm' ,'FilterBackgroundPresetColor'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*11, ...
    'Filter n*', 'FilterStimulusPresetColor', ...
    1, 19, [1, 1], fnTsGetVar('g_strctParadigm' ,'FilterStimulusPresetColor'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*12, ...
    'CLut n*', 'FilterCLutPresetColor', ...
    1, 10, [1, 1], fnTsGetVar('g_strctParadigm' ,'FilterCLutPresetColor'));

	
strctControllers.m_hUpdateStimulusPosition = uicontrol('Parent', strctFilterControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Update Stimulus Location',...
      'Position', [5 iPanelHeight-iOffset-180 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UpdateStimulusPosition'');']);	
	  
strctControllers.m_hSetRandomStimulusPosition = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Randomize Position','value',...
	g_strctParadigm.m_bRandomStimulusPosition,...
    'Position', [5 iPanelHeight-iOffset-200 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandStimulusLocation'');']);
	
strctControllers.m_hSetRandomStimulusOrientation = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Randomize Orientation','value',...
	g_strctParadigm.m_bRandomStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-220 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandStimulusOrientation'');']);	


strctControllers.m_hSetCycleStimulusOrientation = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Cycle Orientation','value',...
	g_strctParadigm.m_bCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-240 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''CycleStimulusOrientation'');']);	
	
strctControllers.m_hSetReverseCycleStimulusOrientation = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Reverse Orientation','value',...
	g_strctParadigm.m_bReverseCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-260 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ReverseCycleStimulusOrientation'');']);

strctControllers.m_hUseBlackBackground = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Black Background','value',...
	g_strctParadigm.m_bUseBlackBackground,...
    'Position', [5 iPanelHeight-iOffset-280 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UseBlackBackground'');']);
...
strctControllers.m_hClearCurrentTestObjects = uicontrol('Parent', strctFilterControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Clear Test Variables',...
      'Position', [5 iPanelHeight-iOffset-300 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ClearCurrentTestObjects'');']);	
	
strctControllers.m_hSetCurrentTestObject = uicontrol('Parent', strctFilterControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Set Test Variable',...
      'Position', [5 iPanelHeight-iOffset-320 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SetCurrentSelectedVariableAsTestObject'');']);	

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*22, ...
    'Set Test Range', 'FilterCurrentVariableModifyRange', ...
    1, 200, [1, 1], fnTsGetVar('g_strctParadigm' ,'CurrentVariableModifyRange'));
	  
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctFilterControllers.m_hPanel, 40+30*23, ...
    'Set Test Hz', 'FilterCurrentVariableModifySpeedHz', ...
    1, 200, [1, 1], fnTsGetVar('g_strctParadigm' ,'CurrentVariableModifySpeedHz'));	  
	
strctControllers.m_hSetReverseCycleStimulusOrientation = uicontrol('Parent',strctFilterControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Test Value','value',...
	g_strctParadigm.m_bRandomTestValue,...
    'Position', [5 iPanelHeight-iOffset-400 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SetRandomTestValue'');']);	
...
set(strctFilterControllers.m_hPanel,'visible','off');
