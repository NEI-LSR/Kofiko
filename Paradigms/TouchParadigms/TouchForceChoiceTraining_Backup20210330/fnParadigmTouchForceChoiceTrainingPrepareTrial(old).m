...
if strctCurrentTrial.m_strctStimuliVars.m_bDirectMatchCueChoices || rand() > (strctCurrentTrial.m_strctStimuliVars.m_fProbeTrialProbability/100)
    ...
    strctCurrentTrial.m_aiActiveChoiceColorID = sort([strctCurrentTrial.m_strctCuePeriod.m_iSelectedColorID, ...
    ...
    Distractors = strctCurrentTrial.m_aiAllChoiceColorIDs(strctCurrentTrial.m_aiAllChoiceColorIDs~=strctCurrentTrial.m_strctCuePeriod.m_iSelectedColorID);
    strctCurrentTrial.m_aiActiveChoiceColorID = sort(Distractors(randperm(strctCurrentTrial.m_strctChoiceVars.numColors-1,strctCurrentTrial.m_strctChoiceVars.m_NTargets))); % subset random non-match hues for each trial
end
...
if strcmpi(g_strctParadigm.m_strctChoiceVars.m_strChoiceDisplayType, 'disc') || ...
    ...
    elseif strcmpi(g_strctParadigm.m_strctChoiceVars.m_strChoiceDisplayType, 'nestedannuli')
        ...
        stimseparation = (numel(g_strctParadigm.m_ciQuadrantsSelected) * 90)/numel(g_strctParadigm.m_ciQuadrantsSelected);
        ...
        %	if g_strctParadigm.m_strctChoiceVars.m_bRotateChoiceRingOnEachTrial
        %		strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas(1+mod([1:length(strctCurrentTrial.m_strctChoiceVars.m_afChoiceThetas)]+randi([1 strctCurrentTrial.m_strctChoiceVars.m_NTargets], [1 1]), strctCurrentTrial.m_strctChoiceVars.m_NTargets));
        %	end
