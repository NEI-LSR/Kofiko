...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctCueControllers.m_hPanel,40+30*6, ...
    'Starting hue:', 'StartingHue', 0, 100, [1, 5], fnTsGetVar('g_strctParadigm','StartingHue'));		
...
strctControllers.m_hDirectMatch = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Force direct match cue to choices','value',...
    ...
    'Position', [5 iPanelHeight-490 250 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''DirectMatch'');']);
...
strctControllers.m_hSetInvertChoiceRingOnEachTrial = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Ring Inversion','value',...
   ...
   'Position', [5 iPanelHeight-515 250 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandomInvertChoiceRing'');']);
...
strctControllers.m_hSetRotateRingOnEachTrial = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Ring Rotation','value',...
   ...
   'Position', [5 iPanelHeight-540 250 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RotateChoiceRingOnEachTrial'');']);
   %{
...
strctControllers.m_hForceChoiceColorConversionMatchToCueType = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Match Conversion to Cue','value',...
   ...
   'Position', [5 iPanelHeight-565 250 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ForceChoiceColorConversionMatchToCueType'');']);
strctControllers.m_bSortChoiceHues = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Sort Choices by Hue','value',...
   ...
   'Position', [5 iPanelHeight-590 250 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''SortChoiceHues'');']);  
   %{
...
strctControllers.m_hAFCChoiceLocation = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Update Choice Location',...
    'Position', [5 iPanelHeight-615 250 25],'callback', [g_strctParadigm.m_strCallbacks,'(''AFCChoiceLocation'');']);
...
strctControllers.m_hGenerateChoiceTextures = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Generate Choice Textures',...
    'Position', [5 iPanelHeight-645 250 25],'callback', [g_strctParadigm.m_strCallbacks,'(''GenerateChoices'');']);	
...
%    'Position', [10 strctChoicesControllers.m_iPanelHeight-545 strctChoicesControllers.m_iPanelWidth-15 55], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectSaturations'');'],...
...
%    'Position', [10 strctChoicesControllers.m_iPanelHeight-655 ,strctChoicesControllers.m_iPanelWidth-15 95], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectColors'');'],...
