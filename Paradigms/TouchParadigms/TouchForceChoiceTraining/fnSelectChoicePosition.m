function apt2fPositions = fnSelectChoicePosition(strArrangement, iNumChoices, iChoiceBoundingBoxSizePix, varargin)
...
switch lower(strArrangement)
    case 'leftright'
		fixationCenterOffset = varargin{1};
		apt2fPositions = [fWidth/2-fixationCenterOffset, fHeight/2;
							fWidth/2+fixationCenterOffset, fHeight/2];
    case 'topbottom'
		fixationCenterOffset = varargin{1};
		apt2fPositions = [fWidth/2, fHeight/2-fixationCenterOffset;
							fWidth/2, fHeight/2+fixationCenterOffset];
    case 'grid2x2'
