...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'ChoiceDistributionSpread', g_strctParadigm.m_fInitial_ChoiceDistributionSpread, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'EasyTrialProbability', g_strctParadigm.m_fInitial_EasyTrialProbability, iSmallBuffer);
