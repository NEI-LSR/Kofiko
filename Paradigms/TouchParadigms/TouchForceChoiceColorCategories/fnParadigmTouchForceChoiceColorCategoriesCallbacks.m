function fnParadigmTouchForceChoiceTrainingCallbacks(strCallback,varargin)
%
...
fnInitializeCueTrainingTextures(stimulusTypeToPrepare, fnTsGetVar('g_strctParadigm', 'NumTexturesToPreparePerCue'), ...
    ...
    case 'TrialOutcome'
		...
		% not sure what this does, but it doesn't seem to do anything for now anyways (except break) 
		%{
    ...
    case 'ChangeTR'
        ...
        if isreal(fNewTRValue) && ~isnan(fNewTRValue)
            ...
            [strctCurrentTrial,strWhatHappened] =  fnParadigmTouchForceChoiceColorCategoriesPrepareTrial();
