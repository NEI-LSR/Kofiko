...
if ~nargin
	...
	DirVector1 = [g_strctParadigm.m_strctCurrentTrial.m_strctPreCuePeriod.m_pt2fFixationPosition] - ...
				[g_strctParadigm.m_strctCurrentTrial.m_strctPreCuePeriod.m_pt2fFixationPosition(1), g_strctParadigm.m_strctCurrentTrial.m_strctTrialParams.m_aiStimServerScreen(4)];
	% Fixation point to selected choice location
	DirVector2 = [g_strctParadigm.m_strctCurrentTrial.m_strctPreCuePeriod.m_pt2fFixationPosition] - ...
	...
	%varargin{1}.m_strctChoicePeriod.m_pt2fFixationPosition
	
	
	DirVector1 = [varargin{1,1}.m_strctChoicePeriod.m_pt2fFixationPosition] - ...
				[varargin{1,1}.m_strctChoicePeriod.m_pt2fFixationPosition(1), varargin{1,1}.m_strctTrialParams.m_aiStimServerScreen(4)];
	% Fixation point to selected choice location # 1
	DirVector2 = [varargin{1,1}.m_strctChoicePeriod.m_pt2fFixationPosition] - ...
				[varargin{2}(1,:)];
