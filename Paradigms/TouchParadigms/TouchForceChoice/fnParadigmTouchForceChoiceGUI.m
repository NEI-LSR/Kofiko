...
strctControllers.m_hGenerateCueTextures = uicontrol('Parent', strctCueControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Generate Cue Textures',...
      'Position', [5 strctCueControllers.m_iPanelHeight-275 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''GenerateCues'');']);
...
strctControllers.m_hSetCueHighlight = uicontrol('Parent',strctCueControllers.m_hPanel,'Style', 'checkbox', 'String', 'Highlight Cue','value',...
    ...
    'Position', [5 strctCueControllers.m_iPanelHeight-300 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''HighlightCue'');']);
...
strctControllers.m_hSetShowCue = uicontrol('Parent',strctCueControllers.m_hPanel,'Style', 'checkbox', 'String', 'Display Cue','value',...
    ...
    'Position', [5 strctCueControllers.m_iPanelHeight-325 130 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ShowCue'');']);
...
strctControllers.m_hCueColorLists = uicontrol('Style', 'listbox', 'String', colorCell,...
    ...
    'value',max(1,g_strctParadigm.m_strctInitialValues.m_afInitial_SelectedCueColors),'UIContextMenu',strctControllers.hColorListContextMenu, 'max', 16, 'min', 0);
%}
stimTypes = {'disc','bar'};
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers, strctChoicesControllers.m_hPanel,40+30*6, ...
    'Choice Luminance Deviation:', 'ChoiceLuminanceDeviation', 0, 100, [1, 5], fnTsGetVar('g_strctParadigm', 'SaturationBoundaryWidthMultiplier'));
...
strctControllers.m_hSetRotateRingOnEachTrial = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Ring Rotation','value',...
   ...
   'Position', [5 iPanelHeight-510 250 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RotateChoiceRingOnEachTrial'');']);
...
strctControllers.m_hSetInsertGrayBoundaryInChoiceColorRing = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Gray Boundary In color Ring','value',...
   ...
   'Position', [5 iPanelHeight-540 250 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''InsertGrayBoundaryBetweenChoiceColors'');']);
...
strctControllers.m_hSetInsertGrayBoundaryInChoiceSaturationRing = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Gray Boundary in Saturation Ring','value',...
    ...
    'Position', [5 iPanelHeight-570 250 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''InsertGrayBoundaryBetweenChoiceSaturations'');']);
...
strctControllers.m_hForceChoiceColorConversionMatchToCueType = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'Match Conversion to Cue','value',...
   ...
   'Position', [5 iPanelHeight-600 250 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ForceChoiceColorConversionMatchToCueType'');']);
...
strctControllers.m_hSetStimulusOverRide = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'checkbox', 'String', 'OverRide Stimulus Control','value',...
    ...
    'Position', [5 iPanelHeight-630 250 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''OverRideStimulusControl'');']);
...
strctControllers.m_hAFCChoiceLocation = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Update Choice Location',...
    'Position', [5 iPanelHeight-660 250 30],'callback', [g_strctParadigm.m_strCallbacks,'(''AFCChoiceLocation'');']);
...
strctControllers.m_hGenerateChoiceTextures = uicontrol('Parent',strctChoicesControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Generate Choice Textures',...
    'Position', [5 iPanelHeight-690 250 30],'callback', [g_strctParadigm.m_strCallbacks,'(''GenerateChoices'');']);	
...
strctControllers.m_hChoiceDisplayType = uicontrol('Style', 'listbox', 'String', g_strctParadigm.m_acAvailableChoiceDisplayTypes,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-660 strctChoicesControllers.m_iPanelWidth-15 60], 'parent', strctChoicesControllers.m_hPanel, 'Callback', [g_strctParadigm.m_strCallbacks, '(''ChoiceDisplayType'');'],...
...
strctControllers.m_hChoiceColorConversionType = uicontrol('Style', 'listbox', 'String', g_strctParadigm.m_acAvailableColorSpaceNames,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-710 strctChoicesControllers.m_iPanelWidth-15 40], 'parent', strctChoicesControllers.m_hPanel, 'Callback', [g_strctParadigm.m_strCallbacks, '(''ChoiceSelectConversionType'');'],...
    'value', g_strctParadigm.m_strctInitialValues.m_fInitial_ColorConversionID, 'UIContextMenu', strctControllers.hColorListContextMenu, 'max', 1, 'min', 1);
	%g_strctParadigm.m_iCurrentColorConversionID = g_strctParadigm.m_strctInitialValues.m_fInitial_ColorConversionID;
...
strctControllers.m_hChoiceSaturationLists = uicontrol('Style', 'listbox', 'String', a2cCharMatrix,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-810 strctChoicesControllers.m_iPanelWidth-15 100], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectSaturations'');'],...
    'value',g_strctParadigm.m_strctInitialValues.m_afInitial_SelectedChoiceSaturations,'UIContextMenu',strctControllers.hColorListContextMenu, 'max', size(a2cCharMatrix,1),'min',0);
...
strctControllers.m_hChoiceColorLists = uicontrol('Style', 'listbox', 'String', colorCell,...
    'Position', [10 strctChoicesControllers.m_iPanelHeight-920 ,strctChoicesControllers.m_iPanelWidth-15 100], 'parent',strctChoicesControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''ChoiceSelectColors'');'],...
    'value',g_strctParadigm.m_strctInitialValues.m_afInitial_SelectedChoiceColors,'UIContextMenu',strctControllers.hColorListContextMenu, 'max', 16, 'min', 0);
%}	
