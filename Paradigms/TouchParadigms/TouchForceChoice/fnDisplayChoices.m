function [fChoicesOnsetTS] = fnDisplayChoices(hPTBWindow, strctCurrentTrial,bFlip,bClear)
global  g_strctPTB
% Clear screen
...
strctCurrentTrial.m_strctChoiceVars.m_iChoiceTextureIDs,...
	...
	fnDrawFixationSpot(g_strctPTB.m_hWindow, strctCurrentTrial.m_strctChoicePeriod, false , g_strctPTB.m_fScale);
    fChoicesOnsetTS = nan;
