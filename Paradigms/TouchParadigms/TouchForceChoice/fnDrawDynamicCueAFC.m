function [fLastFlipTime] = fnDrawDynamicCueTraining(h_PTBWindow, bFlip)
global g_strctPTB 
if g_strctPTB.m_bRunningOnStimulusServer
	...
	elseif strcmp(g_strctParadigm.m_strctCurrentTrial.m_strctTrialParams.m_strStimulusType,'disc')
		Screen('FillArc', h_PTBWindow, g_strctParadigm.m_strctCurrentTrial.m_strctCuePeriod.m_aiLocalStimulusColors, g_strctPTB.m_fScale * g_strctParadigm.m_strctCurrentTrial.m_strctTrialParams.m_strctStimulusVariables.m_aiBar_rect', 0, 360);
