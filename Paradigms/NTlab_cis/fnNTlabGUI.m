...
strctControllers.m_hSubPanels = [strctDesignControllers.m_hPanel;...
                                ...
                                strctDualstimControllers.m_hPanel] ;% Siva added for Many Bars
...
strctControllers.m_ahStimuliControllerButtons = [strctControllers.m_hSetPlainBarPanel, strctControllers.m_hSetMovingBarPanel,...
					...
					strctControllers.m_hSetImagePanel, strctControllers.m_hSetMoviePanel, strctControllers.m_hSetDualstimPanel, strctControllers.m_hSetDesignPanel  strctControllers.m_hSetStatisticsPanel,...
...
strctControllers.m_ahStimuliControllerButtonsStrLookup = {'PlainBarPanel','MovingBarPanel','TwoBarPanel','ManyBarPanel', 'GaborPanel','DiscPanel',...
    'ImagePanel','MoviePanel', 'DesignPanel',  'StatisticsPanel','JuicePanel', 'ColorControlPanel','DualstimPanel'};
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*0, ...
    ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm','DualstimWidth'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*1, ...
    ...
    1, 200, [1, 10], fnTsGetVar('g_strctParadigm' ,'DualstimLength'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*3, ...
    'Blur Steps', 'DualstimBlurSteps', ...
    0, 100, [1, 2], fnTsGetVar('g_strctParadigm' ,'DualstimBlurSteps'));
    ...
    0, 1000, [1, 25], fnTsGetVar('g_strctParadigm' ,'DualstimMoveSpeed'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*5, ...
    ...
    1, 15, [1, 1], fnTsGetVar('g_strctParadigm' ,'DualstimNumberOfBars'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDualstimControllers.m_hPanel, 40+30*15, ...
    'Stimulus Color', 'DualstimStimulusPresetColor', ...
    1, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'DualstimStimulusPresetColor'));
...
strctControllers.m_hUpdateSecondaryStimulusPosition = uicontrol('Parent', strctDualstimControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Update Secondary Stimulus Location',...
      'Position', [5 iPanelHeight-iOffset-200 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UpdateSecondaryStimulusPosition'');']);	
...
strctControllers.m_hSetRandomStimulusPosition = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Randomize Position','value',...
	g_strctParadigm.m_bRandomStimulusPosition,...
    'Position', [5 iPanelHeight-iOffset-220 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandStimulusLocation'');']);
...
strctControllers.m_hSetRandomStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Randomize Orientation','value',...
	g_strctParadigm.m_bRandomStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-240 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandStimulusOrientation'');']);	
...
strctControllers.m_hSetCycleStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Cycle Orientation','value',...
	g_strctParadigm.m_bCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-260 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''CycleStimulusOrientation'');']);	
...
strctControllers.m_hSetReverseCycleStimulusOrientation = uicontrol('Parent',strctDualstimControllers.m_hPanel,'Style', 'checkbox', 'String', 'Reverse Orientation','value',...
	g_strctParadigm.m_bReverseCycleStimulusOrientation,...
    'Position', [5 iPanelHeight-iOffset-280 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ReverseCycleStimulusOrientation'');']);	
