function fnParadigmPassiveFixationCallbacksNew(strCallback,varargin)
%
...
%        set(g_strctParadigm.m_strctControllers.m_hFavroiteLists,'enable','on');
	...
	% Changelog 10/22/2013 Josh - adding fit to screen callback comms to stimulus server
	case 'FitToScreen'
		if g_strctParadigm.m_bFitToScreen
			fnParadigmToStimulusServer('FitToScreenOn')
		else
			fnParadigmToStimulusServer('FitToScreenOff')
	% End Changelog ----------------------------------------------------------------------
