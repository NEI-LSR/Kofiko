function fnNTlabCycle(strctInputs, bParadigmPaused)
%
...
switch g_strctParadigm.m_iMachineState
 ...
 % Felix Comment: THIS IS WHERE STIM GETS DEFINED
            g_strctParadigm.m_strctAllPlannedTrials = fnNTlabPrepareTrial();
