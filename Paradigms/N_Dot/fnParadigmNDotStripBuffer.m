function strctStimulusParams = fnParadigmNDotStripBuffer()
%
...
strctStimulusParams.m_fScreenCoverage = ...
    g_strctParadigm.m_strctStimulusParams.ScreenCoverage.Buffer(1,:,g_strctParadigm.m_strctStimulusParams.ScreenCoverage.BufferIdx);
