function bSuccessful = fnParadigmNDotInit()
%
...
strctStimulusParams = fnTsAddVar(strctStimulusParams, 'ScreenCoverage', g_strctParadigm.m_fInitial_ScreenCoverage, 100);
