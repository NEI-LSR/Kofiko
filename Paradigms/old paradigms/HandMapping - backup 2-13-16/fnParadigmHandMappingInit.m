...
for iSaturations = 1:numel(g_strctParadigm.m_aiPresetSaturations)
	...
	g_strctParadigm.m_strctMasterColorTable.(g_strctParadigm.m_acstrSaturationsLookup{iSaturations}).azimuthSteps = ...
									deg2rad(0:360/g_strctParadigm.m_fInitial_SaturationsAzimuthSteps:359);
	...
	[x,y,z] = sph2cart(g_strctParadigm.m_strctMasterColorTable.(g_strctParadigm.m_acstrSaturationsLookup{iSaturations}).azimuthSteps, ...
		ones(1,numel(g_strctParadigm.m_strctMasterColorTable.(g_strctParadigm.m_acstrSaturationsLookup{iSaturations}).azimuthSteps)) * ...
			( g_strctParadigm.m_fInitial_SaturationsElevation/100), ...
	...
	g_strctParadigm.m_strctMasterColorTable.(g_strctParadigm.m_acstrSaturationsLookup{iSaturations}).XYZ(:,3) = z;
    %g_strctParadigm.m_strctMasterColorTable.(g_strctParadigm.SaturationsLookup{iSaturations}).rgb 
    uncorrectedRGB = floor(ldrgyv2rgb(z,x,y)*65535);
...
%}
g_strctParadigm.m_bUseChosenBackgroundColor = 0;
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StaticBarCurrentVariableModifySpeedHz', g_strctParadigm.m_fInitial_CurrentVariableModifySpeedHz, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StaticBarCurrentVariableModifyRange', g_strctParadigm.m_fInitial_CurrentVariableModifyRange, iSmallBuffer);
...
g_strctParadigm.m_strctMRIStim.m_bRandomOrder = false;
...
acFavoriteLists = {'HandMapper','MRIStim'};
