...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctStaticBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Preset Colors','value',...
    ...
    'Position', [5 iPanelHeight-iOffset-120 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UsePlainBarPresetColors'');']); 
	
	
strctControllers.m_hUseCartesianCoordinates = uicontrol('Parent',strctStaticBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use DKL Colors','value',...
	g_strctParadigm.m_bUseCartesianCoordinates,...
    'Position', [5 iPanelHeight-iOffset-140 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UseCartesianCoordinates'');']);
...
strctControllers.m_hFlipForegroundBackground = uicontrol('Parent',strctStaticBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'flip background','value',...
    ...
    'Position', [5 iPanelHeight-iOffset-160 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FlipForegroundBackground'');']);

strctControllers.m_hTogglePhaseShiftOffset = uicontrol('Parent',strctStaticBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Shift Offset','value',...
	g_strctParadigm.m_bPhaseShiftOffset,...
    'Position', [5 iPanelHeight-iOffset-180 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''PhaseShiftOffset'');']);
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*18, ...
    'DKL Radius', 'DKLRadius', ...
    0, 100, [1, 1], fnTsGetVar('g_strctParadigm' ,'DKLRadius'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*19, ...
    'DKL Azimuth steps', 'DKLAzimuthSteps', ...
    1, 320, [1, 1], fnTsGetVar('g_strctParadigm' ,'DKLAzimuthSteps'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*20, ...
    'Color Cycle Hz', 'ColorCycleRate', ...
    0, 80, [1, 1], fnTsGetVar('g_strctParadigm' ,'ColorCycleRate'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*21, ...
    'LM axis', 'CartesianXCoord', ...
    0, 2000, [1, 10], fnTsGetVar('g_strctParadigm' ,'CartesianXCoord'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*22, ...
    'S axis', 'CartesianYCoord', ...
    0, 2000, [1, 10], fnTsGetVar('g_strctParadigm' ,'CartesianYCoord'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*23, ...
    'LMS axis', 'CartesianZCoord', ...
    0, 2000, [1, 10], fnTsGetVar('g_strctParadigm' ,'CartesianZCoord'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*24, ...
    'Phase Shift Offset', 'ShiftOffsetDegrees', ...
    0, 2000, [1, 10], fnTsGetVar('g_strctParadigm' ,'ShiftOffsetDegrees'));
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Calibrated Colors','value',...
	...
	%}
strctControllers.m_hSetCycleColors = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Cycle Colors','value',...
	g_strctParadigm.m_bCycleColors,...
    'Position', [5 iPanelHeight-iOffset-320 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''CycleColors'');']);	

strctControllers.m_hSetRandomColor = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Random Color','value',...
	g_strctParadigm.m_bRandomColor,...
    'Position', [5 iPanelHeight-iOffset-340 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''RandomColorOrder'');']);	
	
strctControllers.m_hSetReverseColorOrder = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Reverse Color Order','value',...
	g_strctParadigm.m_bReverseColorOrder,...
    'Position', [5 iPanelHeight-iOffset-360 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''ReverseColorOrder'');']);
...
strctControllers.m_hFlipForegroundBackgroundMovingBar = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Flip fore-back colors','value',...
    ...
    'Position', [5 iPanelHeight-iOffset-400 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FlipForegroundBackgroundMovingBar'');']);	
...
strctControllers.m_hSetTuningFunction = uicontrol('Parent', strctTuningFuncControllers.m_hPanel, 'Style', 'pushbutton', 'String', 'Reset',...
