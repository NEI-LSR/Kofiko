...
if ~isempty(g_strctParadigm.m_strctCurrentTrial.m_fImageFlipON_TS_StimulusServer) &&...
    ...
    elseif g_strctRealTimeStatServer.m_bTrialInfoWait && ~isempty(g_strctParadigm.m_strHandMappingCommandToStatServer) || g_strctParadigm.m_strctStatServerComm.m_bUpdateRequested
