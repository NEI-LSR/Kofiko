...
strctControllers.m_hTogglePSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle orientation polar',...
     'Position', [2*iButtonWidth+40 iPanelHeight-350 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''toggleorientationpolar'');']);

strctControllers.m_hTogglePSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle isi plot',...
     'Position', [2*iButtonWidth+40 iPanelHeight-400 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''toggleisiplot'');']);

strctControllers.m_hTogglePSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle position plot',...
     'Position', [2*iButtonWidth+40 iPanelHeight-450 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglepositionheatmap'');']);
