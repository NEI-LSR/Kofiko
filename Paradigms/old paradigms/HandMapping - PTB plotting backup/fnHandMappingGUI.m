...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*12, ...
    ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'StaticBarStimulusPresetColor'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStaticBarControllers.m_hPanel, 40+30*13, ...
    'Background Color', 'StaticBarBackgroundPresetColor', ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'StaticBarBackgroundPresetColor'));
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctStaticBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Preset Colors','value',...
	g_strctParadigm.m_bUsePresetColors,...
    'Position', [5 iPanelHeight-iOffset-200 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UsePresetColors'');']);
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMovingBarControllers.m_hPanel, 40+30*7, ...
    ...
    0, 4096, [1, 2], fnTsGetVar('g_strctParadigm' ,'MovingBarStimulusOnTime'));
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMovingBarControllers.m_hPanel, 40+30*15, ...
    ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'MovingBarStimulusPresetColor'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMovingBarControllers.m_hPanel, 40+30*16, ...
    'Background Color', 'MovingBarBackgroundPresetColor', ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'MovingBarBackgroundPresetColor'));
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Calibrated Colors','value',...
	g_strctParadigm.m_bUseCalibratedColors,...
    'Position', [5 iPanelHeight-iOffset-260 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UseCalibratedColors'');']);
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctMovingBarControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Preset Colors','value',...
	g_strctParadigm.m_bUsePresetColors,...
    'Position', [5 iPanelHeight-iOffset-300 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UsePresetColors'');']);
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctGaborControllers.m_hPanel, 40+30*15, ...
    ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'GaborStimulusPresetColor'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctGaborControllers.m_hPanel, 40+30*16, ...
    'Background Color', 'GaborBackgroundPresetColor', ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'GaborBackgroundPresetColor'));
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctGaborControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Preset Colors','value',...
	g_strctParadigm.m_bUsePresetColors,...
    'Position', [5 iPanelHeight-iOffset-240 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UsePresetColors'');']);
...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDiscControllers.m_hPanel, 40+30*14, ...
    ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'DiscStimulusPresetColor'));
	
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctDiscControllers.m_hPanel, 40+30*15, ...
    'Background Color', 'DiscBackgroundPresetColor', ...
    0, 8, [1, 1], fnTsGetVar('g_strctParadigm' ,'DiscBackgroundPresetColor'));
...
strctControllers.m_hUseCalibratedColors = uicontrol('Parent',strctDiscControllers.m_hPanel,'Style', 'checkbox', 'String', 'Use Preset Colors','value',...
	g_strctParadigm.m_bUsePresetColors,...
    'Position', [5 iPanelHeight-iOffset-280 120 20], 'Callback', [g_strctParadigm.m_strCallbacks,'(''UsePresetColors'');']);
