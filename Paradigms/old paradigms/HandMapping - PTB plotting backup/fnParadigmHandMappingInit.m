...
global g_strctParadigm g_strctStimulusServer g_strctPTB g_strctAppConfig g_strctPlexon g_strctLocalExperimentRecording g_strctSystemCodes g_strctCycle
% Edits By Josh
...
g_strctLocalExperimentRecording = cell(200000,1);
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StaticBarBackgroundPresetColor', g_strctParadigm.m_fInitial_StaticBarBackgroundPresetColor, iSmallBuffer);
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'MovingBarBackgroundPresetColor', g_strctParadigm.m_fInitial_MovingBarBackgroundPresetColor, iSmallBuffer);
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'GaborBackgroundPresetColor', g_strctParadigm.m_fInitial_GaborBackgroundPresetColor, iSmallBuffer);
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'DiscBackgroundPresetColor', g_strctParadigm.m_fInitial_DiscBackgroundPresetColor, iSmallBuffer);
