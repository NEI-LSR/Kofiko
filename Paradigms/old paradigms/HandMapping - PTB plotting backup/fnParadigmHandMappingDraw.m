...
if ~isempty(g_strctParadigm.m_strctCurrentTrial) && ~strcmp(g_strctParadigm.m_strctCurrentTrial.m_strTrialType,'Plain Bar')...
	...
	if g_strctParadigm.m_bClipStimulusOutsideStimArea

		Screen('FillRect', g_strctPTB.m_hWindow, g_strctParadigm.m_strctCurrentTrial.m_afBackgroundColor, g_strctParadigm.m_strctCurrentTrial.m_aiNonStimulusAreas);
...
if ~isempty(plotCommands) && ...
  (GetSecs() - g_strctPlexon.m_strctStatistics.m_fLastRasterUpdate > 1/g_strctPlexon.m_strctStatistics.m_iRasterUpdateHz)
...
%,'UpdateHistogram'
	...
	Screen('FrameRect',g_strctPTB.m_hWindow, g_strctPlexon.m_strctStatistics.m_aiRasterColors, g_strctPlexon.m_strctStatistics.m_aiRasterPlottingRect);
	Screen('DrawLines',g_strctPTB.m_hWindow, g_strctPlexon.m_aiRasterPlottingArray, [],g_strctPlexon.m_strctStatistics.m_aiRasterColors )
    %{
