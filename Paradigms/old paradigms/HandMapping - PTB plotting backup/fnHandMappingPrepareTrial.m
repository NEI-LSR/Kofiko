...
if g_strctParadigm.m_bRealTimeCycleColors
    [strctTrial] = fnCycleColor(g_strctParadigm, strctTrial);
else
...
if g_strctParadigm.m_strctHandMappingParameters.m_bRandomStimulusOrientation
	ClockRandSeed();
	strctTrial.m_iRotationBin = round(19.*rand(1,1) + 1);
    strctTrial.m_fRotationAngle = strctTrial.m_iRotationBin * 18;
...
function [strctTrial] = fnCycleColor(g_strctParadigm, strctTrial);
	%NumColors = size()
