...
strctControllers.m_ahStimuliControllerButtons = [strctControllers.m_hSetPlainBarPanel, strctControllers.m_hSetMovingBarPanel,...
					strctControllers.m_hSetTwoBarPanel, strctControllers.m_hSetGaborPanel, strctControllers.m_hSetDiscPanel,...
					strctControllers.m_hSetImagePanel, strctControllers.m_hSetMoviePanel];
...
strctControllers.m_ahStimuliControllerButtonsStrLookup = {'PlainBarPanel','MovingBarPanel','TwoBarPanel','GaborPanel','DiscPanel','ImagePanel','MoviePanel'};
...
strctControllers.m_hClearOrientationBuffer = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'clear orientation buffer',...
     'Position', [2*iButtonWidth+80 iPanelHeight-250 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''flushorientationspikebuffer'');']);
...
strctControllers.m_hClearColorBuffer = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'clear color buffer',...
     'Position', [2*iButtonWidth+80 iPanelHeight-200 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''flushcolorspikebuffer'');']);
...
strctControllers.m_hClearPositionBuffer = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'clear position buffer',...
     'Position', [2*iButtonWidth+80 iPanelHeight-300 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''flushpositionspikebuffer'');']);
...
strctControllers.m_hTogglePSTHPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle psth plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-350 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglepsthplot'');']);
...
strctControllers.m_hToggleOrientationPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle orientation polar',...
     'Position', [2*iButtonWidth+80 iPanelHeight-400 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''toggleorientationpolar'');']);
...
strctControllers.m_hToggleISIPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle isi plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-450 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''toggleisiplot'');']);
...
strctControllers.m_hTogglePositionPlot= uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle position plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-500 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglepositionplot'');']);
...
strctControllers.m_hToggleVariableWidthPlot = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle Width plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-550 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglewidthplot'');']);
...
strctControllers.m_hToggleVariableLengthPlot = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle Length plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-600 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglelengthplot'');']);
...
strctControllers.m_hToggleVariableSpeedPlot = uicontrol('Parent',strctStatisticsControllers.m_hPanel,'Style', 'pushbutton', 'String', 'toggle Speed plot',...
     'Position', [2*iButtonWidth+80 iPanelHeight-650 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''togglespeedplot'');']);
%{
