function bSuccess = fnLoadHandMappingDesign(strImageList)
%
...
% Edited by Joshua Fuller-Deets 6-9-2014
% We don't have a set design for the hand mapping paradigm, but it's easier to not disrupt the normal control flow
% of Kofiko, so we short-circuit this function and just return success.
