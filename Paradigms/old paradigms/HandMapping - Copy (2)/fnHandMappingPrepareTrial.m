...
global g_strctParadigm g_strctPTB g_bRecording g_strctLocalExperimentRecord
%fCurrTime = GetSecs;
ClockRandSeed();
...
if g_strctParadigm.m_bCycleColors
    [strctTrial] = fnChooseColor(g_strctParadigm, strctTrial);
...
if g_strctParadigm.m_bUseCartesianCoordinates
    ...
    strctTrial.m_aiLocalStimColor = round(rgb);
    strctTrial.m_aiStimColor = round(rgb * 65535);
...
strctTrial.m_aiLocalStimColor = strctTrial.m_aiStimColor;
% Background color
strctTrial.m_afBackgroundColor = [squeeze(g_strctParadigm.StaticBarBackgroundRed.Buffer(1,:,g_strctParadigm.StaticBarBackgroundRed.BufferIdx))...
    squeeze(g_strctParadigm.StaticBarBackgroundGreen.Buffer(1,:,g_strctParadigm.StaticBarBackgroundGreen.BufferIdx))...
    squeeze(g_strctParadigm.StaticBarBackgroundBlue.Buffer(1,:,g_strctParadigm.StaticBarBackgroundBlue.BufferIdx))];
strctTrial.m_afLocalBackgroundColor = strctTrial.m_afBackgroundColor;
strctTrial.m_bUseBitsPlusPlus = 0;
%ColorCycleRate
%end
%}
%{
...
if ~strctTrial.m_bBlur
    ...
    if strctTrial.m_bUseBitsPlusPlus
        ...
        strctTrial.m_aiBlurStepHolder(1,:) = linspace(strctTrial.m_afLocalBackgroundColor(1),strctTrial.m_aiStimColor(1),strctTrial.numberBlurSteps);
        strctTrial.m_aiBlurStepHolder(2,:) = linspace(strctTrial.m_afLocalBackgroundColor(2),strctTrial.m_aiStimColor(2),strctTrial.numberBlurSteps);
        strctTrial.m_aiBlurStepHolder(3,:) = linspace(strctTrial.m_afLocalBackgroundColor(3),strctTrial.m_aiStimColor(3),strctTrial.numberBlurSteps);
    end
	%}
...
% --------------------------------------------------------------------------------------------------------------------------------------------------------------
%{
function [strctTrial] = fnChooseColor(g_strctParadigm, strctTrial)
...
%{
strctTrial.m_afLocalBackgroundColor = [squeeze(g_strctParadigm.MovingBarBackgroundRed.Buffer(1,:,g_strctParadigm.MovingBarBackgroundRed.BufferIdx))...
    squeeze(g_strctParadigm.MovingBarBackgroundGreen.Buffer(1,:,g_strctParadigm.MovingBarBackgroundGreen.BufferIdx))...
    squeeze(g_strctParadigm.MovingBarBackgroundBlue.Buffer(1,:,g_strctParadigm.MovingBarBackgroundBlue.BufferIdx))];
%}
...
elseif g_strctParadigm.m_bCycleColors || g_strctParadigm.m_bRandomColor
    %NumColors = size()
    %if g_strctParadigm.m_fLastColorCycleUpdate
	strctTrial.m_afBackgroundColor = g_strctParadigm.m_aiCalibratedBackgroundColor
	trctTrial.m_afLocalBackgroundColor = round((strctTrial.m_afBackgroundColor/65535)*255)
    strctTrial.m_bUseBitsPlusPlus = 1;
