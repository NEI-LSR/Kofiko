...
sprintf('currently selected variable = %s', g_strctParadigm.m_strCurrentlySelectedVariable)
sprintf('strCallback = %s', strCallback)
switch strCallback
	...
	g_strctParadigm.m_strHandMappingCommandToStatServer = 'flushorientationspikebuffer';
	...
	case 'flushcolorspikebuffer'
		...
		g_strctParadigm.m_strHandMappingCommandToStatServer = 'flushcolorspikebuffer';
