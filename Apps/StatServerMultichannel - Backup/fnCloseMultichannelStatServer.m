function fnCloseMultichannelStatServer()
...
if ~g_strctCycle.m_bShutDownDone
    ...
    astrctScripts = dir('.\Apps\StatServerMultichannel\ExitScripts\*.m');
    ...
    fnCloseMultichannelListeningSocket();
    fnDisconnectFromNeuralMultichannelServer();
