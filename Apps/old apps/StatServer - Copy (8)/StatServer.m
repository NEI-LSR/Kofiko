...
g_strctStatistics.m_bPlotISI = false;
g_strctStatistics.m_bPlotPSTH = true;
g_strctStatistics.m_bPlotOrientationPolar = true;
g_strctStatistics.m_strctEnabledPlots.m_bPositionHeatmapEnabled = false;
...
if exist('Z:\new calibratin\colorVals.mat')
    ...
    for iNumFields = 1: size(strctColorValues.fieldNames,1)
        ...
        strctColorValues.allxyYCoordinates = vertcat(strctColorValues.allxyYCoordinates, strctColorValues.(nameOfField).xyY);
...
g_strctStatistics.m_strctEnabledPlots.m_bPositionHeatmapEnabled = 1;
...
g_strctNeuralServer.m_iTrialsToKeepInBuffer = 50000;
