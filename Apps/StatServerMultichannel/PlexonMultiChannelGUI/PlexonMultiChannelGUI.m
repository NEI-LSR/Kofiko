function varargout = PlexonMultiChannelGUI(varargin)
...
acActiveAnalogChannels = acAnalogChannelNames(aiActiveAnalogChannels(aiActiveAnalogChannels ~= 0)); % ordering is important!
