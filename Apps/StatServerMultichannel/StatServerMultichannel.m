...
addpath('Z:\Apps\StatServerMultichannel')
...
g_strctStatistics = [];
g_strctStatistics.m_iNumOrientationBins = 36;
g_strctStatistics.m_strctMovingBarStats.m_iOrientationBinID = zeros(g_strctStatistics.m_iNumOrientationBins,1);
g_strctStatistics.m_iNumColorBins = 16;
%%
fNow = now;
...
%}
bSuccess = fnConnectToNeuralMultichannelServer(); %need to ensure
%mkTurkPlus edits still work here
...
g_strctStatistics.m_aiOrientationSpikeHolder = zeros(g_strctStatistics.m_iNumOrientationBins,5000,5);
g_strctStatistics.m_aiColorSpikeHolderIDX = ones(16,5);
g_strctStatistics.m_aiOrientationSpikeHolderIDX = ones(g_strctStatistics.m_iNumOrientationBins,5);
...
g_strctStatistics.m_strctEnabledPlots.m_bPSTHEnabled = 0;
g_strctStatistics.m_strctEnabledPlots.m_bLUVPSTHEnabled = 0;
...
g_strctStatistics.m_strctEnabledPlots.m_bVariableLengthPlotEnabled = 0;
g_strctStatistics.m_strctEnabledPlots.m_bVariableWidthPlotEnabled = 0;
g_strctStatistics.m_strctEnabledPlots.m_bVariableSpeedPlotEnabled = 0;
g_strctStatistics.m_strctEnabledPlots.m_bImagePlotEnabled = 0;
...
%g_strctStatistics.m_hColorPSTHFigureHandle = figure();
g_strctStatistics.m_hFigureHandle = figure();
