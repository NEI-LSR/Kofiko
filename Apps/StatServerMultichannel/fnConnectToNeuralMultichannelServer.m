function bSuccess = fnConnectToNeuralMultichannelServer()
...
switch g_strctConfig.m_strctNeuralServer.m_strType
    case 'PLEXON'
		disp('attempting plexon connect')
        g_strctNeuralServer = fnInitializePlexonNeuralMultichannelServer();
    case 'BLACKROCK'
        g_strctNeuralServer = fnInitializeMultichannelBlackRockNeuralServer();
    otherwise
        assert(false);
end
