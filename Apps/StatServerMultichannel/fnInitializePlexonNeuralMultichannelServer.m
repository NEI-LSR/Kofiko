function strctNeuralServer = fnInitializePlexonNeuralMultichannelServer()
...
for i = 1:512 % Felix added to accomodate more channels
...
strctChannels = PlexonMultiChannelGUI(strctNeuralServer.m_acSpikeChannelNames,strctNeuralServer.m_acAnalogChannelNames,strctNeuralServer.m_aiEnabledChannels);
